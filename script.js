...
function updateCountdown() {
  ...
  countdownEl.innerHTML = `${days} gün, ${hours} saat, ${minutes} dakika, ${seconds} saniye kaldi.`;
  ...
  // HTML elementlerinde güncelleme yap
  countdownEl2.innerHTML = `${days2} gün, ${hours2} saat, ${minutes2} dakika, ${seconds2} saniye kaldi:`;
}
